...
<!--Product Aisle-->
<div class="Products_Aisle bg-VF">
  <h1 class="AisleTitle"><strong class="glowTextGreen">Vegetables</strong> and <strong class="glowTextGreen">Fruits</strong></h1>
  <div class="aisle-searchbar">
    <input class="aisle-bar VF-searchbar" type="text" name="VFsearch" placeholder="Search for veggies or fruits...">
  </div>

  <div class="row">
    <?php foreach ($products_data->aisle[0]->product as $product):?>
...
<script type="text/javascript" src="../JS-files/Search.js"></script>
